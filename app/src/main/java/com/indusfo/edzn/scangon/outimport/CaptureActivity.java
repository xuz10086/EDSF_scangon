package com.indusfo.edzn.scangon.outimport;
...
import com.indusfo.edzn.scangon.camera.CameraManager;
import com.indusfo.edzn.scangon.common.BitmapUtils;
...
import com.indusfo.edzn.scangon.decode.BitmapDecoder;
import com.indusfo.edzn.scangon.decode.CaptureActivityHandler;
import com.indusfo.edzn.scangon.view.ViewfinderView;
...
public final class CaptureActivity extends BaseActivity implements
	...
	private void initController() {
		mController = new ScanTaskController(this);
	 ...
	 *
	 * @author xuz
	 * @date 2019/1/8 10:55 AM
	 * @param [rawResult]
	 * @return void
	 */
	private void handlerQrCode(Result rawResult) {

		String codeResult = ResultParser.parseResult(rawResult).toString();

		// 将扫码的结果返回给ScanTaskActivity
...
/*		Intent intent = getIntent();
		int i = intent.getIntExtra("qrCode", 0);
		String taskId = intent.getStringExtra("taskId");
		if (i == IdiyMessage.CAPTURE_MATERIALS) {
			// 发送网络请求
			mController.sendAsynMessage(IdiyMessage.CAPTURE_MATERIALS, codeResult, taskId);
		} else if (i == IdiyMessage.CAPTURE_MATERIALS_SET) {
			// 发送网络请求
			mController.sendAsynMessage(IdiyMessage.CAPTURE_MATERIALS_SET, codeResult, taskId);
		}

		Intent intent2 = new Intent(this, ScanTaskActivity.class);
		intent.putExtra("Qrcode", ResultParser.parseResult(rawResult).toString());
